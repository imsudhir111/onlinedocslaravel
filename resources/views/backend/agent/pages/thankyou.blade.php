                ...
                <div class="bg-white thanks">
                    <div class="row ">
                        ...
                        <div class="backShadowright"></div>
                            ...
                            <h2 style="font-size:3rem; line-height:100px">Thank You !</h2>
                            <p style="font-size:25px; " class="text-justify"><b>"Your payment has been successfull"</b><br>
                            <p style="font-size:25px;">Kindly stay on call with our support team,<br>
                            We are scheduling an appointment for you.</p>
                            </div>
                        </div>
                    </div>
                </div>
