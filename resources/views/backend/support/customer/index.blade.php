				  ...
				  <!-- logo for regular state and mobile devices -->
                     ...
                     <div class="d-flex align-items-center justify-content-center">
                        <a href={{ route('member.dashboard') }}>
                            <br><h1 class="h5">{{ auth()->user()->name }}</h1>
                          </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ route('member.customers') }}"><i class="ti-more"></i>Customer List</a></li>
              <li><a href="components_badges.html"><i class="ti-more"></i>Create New</a></li>
            </ul>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="#"><i class="ti-more"></i>Edit</a></li>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                              <table id="customerlist" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Position</th>
