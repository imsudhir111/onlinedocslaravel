...
<link rel="stylesheet" type="text/css" href="{{ asset('/frontend/css/plans.css')}}"/>

<link rel="stylesheet" type="text/css" href="{{ asset('/frontend/css/calender.css')}}"/>

<link rel="stylesheet" type="text/css" href="{{ asset('/frontend/css/services.css')}}"/>
...
<!--================== Toaster Scripts Starts ==================-->

<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css" >

<!--================== Toaster Scripts Ends ==================-->
